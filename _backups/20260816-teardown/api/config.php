...
define('SHOP_NOTIFY_EMAIL', 'fvillares@gmail.com');

// Envío de mail por SMTP (mail() de PHP no es confiable en muchos hostings).
define('SMTP_HOST', 'mail.psyware.ar');
define('SMTP_PORT', 587);
define('SMTP_SECURE', 'tls'); // STARTTLS
define('SMTP_USER', 'federico@intelix.com.ar');
define('SMTP_PASS', 'FedeVillare$5545');
define('SMTP_FROM', 'federico@intelix.com.ar');
define('SMTP_FROM_NAME', 'Tienda de Intelix');
...
// Cuando está en true, la tienda no genera pagos nuevos (checkout
// pausado temporalmente). Poner en false para reactivarla.
define('TIENDA_CERRADA', false);
